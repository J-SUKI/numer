...
function PolynomialInterpolation_L() {
    ...
    const handleSubmit = (e) => {
        ...
        // Convert the input to arrays of numbers
        ...
        const yTarget = LagrangePolynomial(xValuesArray, yValuesArray, xTargetValue);
        setResult(yTarget.toFixed(6));
    };

    const LagrangePolynomial = (x_values, y_values, x_target) => {
        let y_target = 0.0;
...
export default PolynomialInterpolation_L;
